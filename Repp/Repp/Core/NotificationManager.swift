...
/// Local notifications only — Repp never needs a server to nag you.
enum NotificationManager {
    private static let timeUpID = "repp.notification.time-up"
    private static let dailyID = "repp.notification.daily-nudge"
