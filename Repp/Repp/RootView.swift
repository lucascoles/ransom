...
struct RootView: View {
    ...
    private func bootstrap() {
        ...
        // Fires when the shield's "Earn my time" button is tapped while Repp is
        // already running in the background.
        DarwinNotifications.observe(ReppCore.unlockRequestedNotification) {
            Task { @MainActor in
